...
#########################################
print("Enter the number of books to download (1-5):")       #Get number of files to download
size = int(input())
...
try:
    ...
    print("Aggregate Throughput: ",agg_throughput,"kB/s")                       #Print aggregate throughput

    print(f"Time taken to setup connection: {conn_end - conn_setup} sec")       #Calculate connection setup time
