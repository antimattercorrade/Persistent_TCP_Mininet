...
def main():
    ...
    sleep(0.25)
    popens[J] = J.popen('python3 ../client/tcp_client.py 3 %s &' %S1.IP())
    sleep(0.35)
    popens[K] = K.popen('python3 ../client/tcp_client.py 4 %s &' %S2.IP())
    ...
    # sleep(0.15)
    # popens[M] = M.popen('python3 ../client/tcp_client.py 3 %s &' %S1.IP())
    # sleep(0.45)
    # popens[N] = N.popen('python3 ../client/tcp_client.py 4 %s &' %S2.IP())
    # sleep(0.25)
    # popens[H] = H.popen('python3 ../client/tcp_client.py 1 %s &' %S.IP())
